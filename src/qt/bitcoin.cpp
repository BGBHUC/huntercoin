...
int main(int argc, char *argv[])
{
    ...
    {
        if (boost::filesystem::is_directory(boost::filesystem::system_complete(mapArgs["-datadir"])))
        {
            boost::filesystem::path pathDataDir = boost::filesystem::system_complete(mapArgs["-datadir"]);
